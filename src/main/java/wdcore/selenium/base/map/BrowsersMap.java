...
//			+ File.separator;
    ...
    private static String getIncludesFld() {
        String mvn_includes_fld = Environment.appRoot + File.separator + "src" + File.separator + "main" + File.separator
                + "resources" + File.separator + "includes" + File.separator;
        String eclipse_includes_fld = Environment.appRoot + File.separator + "includes" + File.separator;
        ...
        } else if(new File(eclipse_includes_fld).isDirectory()){
            System.out.println("Includes folder = " + eclipse_includes_fld);
            return eclipse_includes_fld; //for eclipse proj
        } else {
             System.out.println("WARNING! Could not find includes folder!!");
             return null;
        }
    }
}
