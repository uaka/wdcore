...
public class WebdriverMethods extends SeleneseTestBase {
    ...
    public void waitNoElement(String element) throws Exception {
        ...
        WebDriverHelper.setImplicitWaitsOff(driver);
        try {
            new WebDriverWait(driver, timeout).until(elementNotPresent(element));
        } catch (Exception e) {
    ...
    public void waitForNotVisible(String element) throws Exception {
        ...
        WebDriverHelper.setImplicitWaitsOff(driver);
        try {
            new WebDriverWait(driver, timeout).until(elementNotVisible(element));
        } catch (Exception e) {
            throw new Exception("FAIL: Element " + element
                    + " is still visible ");
        }
    ...
    ExpectedCondition<Boolean> textInElementPresent(final String element,
        ...
        return new ExpectedCondition<Boolean>() {
            ...
            public Boolean apply(WebDriver arg0) {
                ...
                return (getText(element).contains(text) || (getText(element).equalsIgnoreCase(text)));
            }
        };
    }
    ...
    public void assertNoText(String element, String text) throws IOException {
        ...
        if ((realText.contains(text) || (realText.contains(text.toUpperCase())) || (realText.equalsIgnoreCase(text)))) {
    ...
    public void assertTextPresent(String text) throws IOException {
        ...
        try {
            if (!(realText.contains(text.toUpperCase()) || realText.contains(text))) {
    ...
    public void assertValue(String element, String value) throws IOException {
        if (!(getValue(element).contains(value) || (getValue(element).equalsIgnoreCase(value)))) {
    ...
    public void assertElement(String element) throws IOException {
        if (!isElementPresent(element)) // throwableFail("Element "+element +" not found!");
        {
...
//		}
        ...
        try {
            Object output = ((JavascriptExecutor) driver).executeScript(script);
            if (output != null) {
    ...
    public String getAttribute(String value) {
        ...
        if (value.lastIndexOf("@") > 0) {
            return getElement(value.substring(0, value.lastIndexOf("@"))).getAttribute(
    ...
    public void mouseMoveAndClick(String element1, String element2) {
        ...
        builder.moveToElement(getElement(element1)).click(getElement(element2)).build().perform();
    }
...
//		WebDriverHelper.setImplicitWaitsOn(driver);
    ...
    public void fireEvent(String element, String eventName) {
        log.debug("fire event " + eventName + " for element " + element);
        JavascriptExecutor js = (JavascriptExecutor) driver;
        String scriptName = getAttribute(element + "@" + eventName);
